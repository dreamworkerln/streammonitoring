package ru.kvanttelecom.tv.streammonitoring.core.data.events.mediaserver;

import lombok.Getter;
import ru.kvanttelecom.tv.streammonitoring.core.data.enums.MediaServerEventType;
...
public class MediaServerEvent {
    ...
    public MediaServerEvent(MediaServerEventType eventType, String streamName, String serverName, Instant time, String reason) {
